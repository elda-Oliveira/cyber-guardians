...
export default function CertificadoFundamentosScreen() {
    ...
    >
      ...
      <ScrollView style={styles.container}>
        ...
        >
          ...
          >
            Demonstrando conhecimentos introdutórios sobre proteção digital,
            senhas seguras, autenticação, links suspeitos e privacidade online.
          </Text>
          ...
          <View style={styles.footer}>
            ...
            <Text style={styles.code}>ID: CG-2026-45821</Text>
          </View>
        </View>
      </ScrollView>
    </View>
