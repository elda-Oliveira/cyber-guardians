...
const perguntas = [
  {
    pergunta: 'Qual informação deve ser protegida?',
    opcoes: ['CPF', 'Cor favorita', 'Filme favorito'],
    correta: 'CPF',
  },
  {
    pergunta: 'O que evitar publicar nas redes sociais?',
    opcoes: ['Memes', 'Fotos de documentos', 'Música favorita'],
    correta: 'Fotos de documentos',
  },
  {
    pergunta: 'Uma boa prática de privacidade é:',
    opcoes: [
      'Aceitar qualquer pessoa',
      'Compartilhar senha',
      'Revisar configurações de privacidade',
    ],
    correta: 'Revisar configurações de privacidade',
  },
];

export default function QuizFundamentos5Screen() {
  ...
  async function finalizarMissao() {
    ...
    const melhorXpAnterior = dados.fundamentos5MelhorXp || 0;
    ...
    await updateDoc(userRef, {
      xp: xpAtual + xpGanho,
      fundamentos5Concluida: true,
      fundamentos5MelhorXp: Math.max(melhorXpAnterior, xp),
      fundamentos5UltimoXpGanho: xpGanho,
      fundamentos5Acertos: acertos,
    });
      ...
      <View style={styles.resultWrapper}>
        <View style={styles.resultBox}>
          ...
          <Text style={styles.resultText}>
            Você concluiu a missão sobre privacidade online.
          </Text>
          ...
          <View style={styles.rewardCard}>
            ...
            <Text style={styles.rewardText}>
              🏅 Distintivo: Guardião da Privacidade
            </Text>
          </View>
