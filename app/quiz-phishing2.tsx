...
const dicas = [
  {
    titulo: 'Dica 1 - Mensagem personalizada',
    texto: '🐱 Detetive Miau: “Esse e-mail usa seu nome para parecer mais verdadeiro.”',
  },
  {
    titulo: 'Dica 2 - Urgência suspeita',
    texto: '🐱 Detetive Miau: “Ele cria pressão dizendo que sua conta será bloqueada em pouco tempo.”',
  },
  {
    titulo: 'Dica 3 - Link perigoso',
    texto: '🐱 Detetive Miau: “O link parece de uma intranet, mas usa um domínio externo suspeito.”',
  },
];

export default function QuizPhishing2Screen() {
  ...
  async function finalizarQuiz() {
    ...
    const melhorXpAnterior = dados.phishing2MelhorXp || 0;
    ...
    await updateDoc(userRef, {
      xp: xpAtual + xpGanho,
      phishing2Concluida: true,
      phishing2MelhorXp: Math.max(melhorXpAnterior, xpAtualMissao),
      phishing2UltimoXpGanho: xpGanho,
      phishing2PontuacaoAtual: xpAtualMissao,
      phishing2DicasUsadas: dicasUsadas,
      ...
      <ScrollView style={styles.container}>
        ...
        >
          ...
          <Text style={[styles.small, { color: dark ? '#CBD5E1' : '#4B5563' }]}>
            De: suporte.ti@empresa-seguranca.com
          </Text>
          ...
          <Text style={[styles.subject, { color: dark ? '#FFFFFF' : '#111827' }]}>
            Assunto: Atualização urgente da sua conta corporativa
          </Text>
        </View>
        ...
        >
          <Text style={[styles.mailText, { color: dark ? '#F8FAFC' : '#111827' }]}>
            Olá Gabriel,
            {'\n\n'}
            Detectamos um login incomum em sua conta da empresa.
            {'\n\n'}
            Para evitar o bloqueio do seu acesso, confirme suas credenciais no portal abaixo:
            {'\n\n'}
            <Text style={styles.link}>http://intranet-seguranca-ti.com/login</Text>
            {'\n\n'}
            Prazo: 30 minutos.
            {'\n\n'}
        ...
        {respondeu && (
          ...
          >
            ...
            <Text style={[styles.feedbackText, { color: dark ? '#CBD5E1' : '#52606D' }]}>
              {acertou
                ? 'Esse é um caso de spear phishing: ele usa seu nome, cria urgência e tenta roubar suas credenciais.'
                : 'Observe que a mensagem usa urgência, link suspeito e pede confirmação de credenciais.'}
            </Text>
      ...
      {mostrarFerramentas && (
        <View style={styles.modalOverlay}>
          ...
          >
            ...
            >
              <Text style={styles.reportTitle}>📜 Relatório de Análise de E-mail</Text>

              <Text style={[styles.reportItem, { color: dark ? '#FFFFFF' : '#111827' }]}>
                👤 Personalização:
              </Text>
              <Text style={[styles.reportText, { color: dark ? '#CBD5E1' : '#111827' }]}>
                “A mensagem usa o nome da vítima para parecer confiável.”
              </Text>
              ...
              <Text style={[styles.reportText, { color: dark ? '#CBD5E1' : '#111827' }]}>
                “O prazo de 30 minutos cria pressão para agir sem pensar.”
              </Text>
              ...
              <Text style={[styles.reportText, { color: dark ? '#CBD5E1' : '#111827' }]}>
                “intranet-seguranca-ti.com parece corporativo, mas não garante que seja oficial.”
              </Text>
              ...
              <Text style={[styles.reportText, { color: dark ? '#CBD5E1' : '#111827' }]}>
                “Solicitar credenciais por link é um forte sinal de golpe.”
              </Text>

              <Text style={[styles.miau, { color: dark ? '#CBD5E1' : '#374151' }]}>
                🐱 Detetive Miau: Confirme sempre com o setor oficial antes de digitar sua senha!
              </Text>
            </View>
          </View>
        </View>
