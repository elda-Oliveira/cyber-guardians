...
const perguntas = [
  {
    pergunta: 'O que é autenticação em 2 etapas?',
    opcoes: [
      'Ter duas contas',
      'Usar dois antivírus',
      'Camada extra de segurança',
    ],
    correta: 'Camada extra de segurança',
  },
  {
    pergunta: 'O que normalmente é usado na segunda etapa?',
    opcoes: [
      'Código de confirmação',
      'Nome completo',
      'Foto do perfil',
    ],
    correta: 'Código de confirmação',
  },
  {
    pergunta: 'A autenticação em 2 etapas ajuda quando:',
    opcoes: [
      'Alguém descobre sua senha',
      'O celular descarrega',
      'A internet cai',
    ],
    correta: 'Alguém descobre sua senha',
  },
];

export default function QuizFundamentos3Screen() {
  ...
  async function finalizarMissao() {
    ...
    const melhorXpAnterior = dados.fundamentos3MelhorXp || 0;
    ...
    await updateDoc(userRef, {
      xp: xpAtual + xpGanho,
      fundamentos3Concluida: true,
      fundamentos3MelhorXp: Math.max(melhorXpAnterior, xp),
      fundamentos3UltimoXpGanho: xpGanho,
      fundamentos3Acertos: acertos,
    });
      ...
      <View style={styles.resultWrapper}>
        <View style={styles.resultBox}>
          ...
          <Text style={styles.resultText}>
            Você concluiu a missão sobre autenticação em 2 etapas.
          </Text>
