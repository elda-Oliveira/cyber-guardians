...
export default function CertificadoPhishingScreen() {
    ...
    >
      ...
      <ScrollView style={styles.container}>
        ...
        >
          ...
          <Text style={[styles.certHeader, { color: '#22C55E' }]}>
          ...
          <Text style={[styles.course, { color: '#22C55E' }]}>
          ...
          >
            Demonstrando conhecimento sobre golpes digitais, spear phishing,
            whaling, vishing e clone phishing.
          </Text>
          ...
          <View style={styles.footer}>
            ...
            <Text style={styles.code}>ID: CG-2026-45823</Text>
          </View>
        </View>
      </ScrollView>
    </View>
