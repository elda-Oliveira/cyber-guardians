...
export default function CertificadoCriptografiaScreen() {
    ...
    >
      ...
      <ScrollView style={styles.container}>
        ...
        >
          ...
          >
            Demonstrando conhecimentos básicos sobre criptografia, proteção de
            dados, chaves digitais e segurança da informação.
          </Text>
          ...
          <View style={styles.footer}>
            ...
            <Text style={styles.code}>ID: CG-2026-45822</Text>
          </View>
        </View>
      </ScrollView>
    </View>
